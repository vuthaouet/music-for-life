...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    /*private void addPlayingSongLayout() {
        ...
        playerRunningOnMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("position", Config.songIndex);
    ...
    public boolean onQueryTextChange(String s) {
        ...
        for (String name : allNameAlbum) {
            if (Format.getConvertedTitle(name).toLowerCase().contains(userInput)) {
                myPlaylist.add(name);
            }
        }
        albumAdapter.updateList(myPlaylist);
        return true;
    }
